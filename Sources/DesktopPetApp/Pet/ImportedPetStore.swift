...
struct ImportedPetStore {
    ...
    func importPetArchive(from archiveURL: URL) throws -> PetDefinition {
        ...
        do {
            try fileManager.copyItem(at: jsonURL, to: destinationDirectoryURL.appendingPathComponent("pet.json"))
